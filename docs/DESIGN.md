...
3A. **CRIAR SALA** — tema em duas etapas (escolhe categoria → escolhe tema dentro da categoria; "← voltar às categorias" para trocar) ou digita um tema livre / "TEMA ALEATÓRIO"; rodadas (3/5/7/10); tempo (atalhos 15/30/45/60s ou "Personalizado" com input em segundos/minutos); CRIAR (desabilitado sem tema).
